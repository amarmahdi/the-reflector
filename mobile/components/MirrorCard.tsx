// ──────────────────────────────────────────────
// The Mirror (Muhasabah) — Home Screen Card
// Reflects your previous day's actions back to you.
...
import { getMissQuote, getSuccessQuote, getStreakQuote } from '@/lib/mirrorQuotes';
  ...
  if (isStreakDay) {
    ...
    return (
      <View style={[styles.card, styles.streakCard]}>
        ...
        <Text style={styles.body}>Your consistency speaks for itself.</Text>
  ...
  if (allCompleted) {
    ...
    return (
      <View style={[styles.card, styles.successCard]}>
        <Text style={styles.mirrorLabel}>🪞  THE MIRROR</Text>
  ...
  if (allMissed) {
    ...
    return (
      <View style={[styles.card, styles.missCard]}>
        ...
        <Text style={styles.quote}>"{quote}"</Text>
        <Text style={styles.cta}>Return today. The door is still open.</Text>
      </View>
    );
  }
  ...
  if (isMixed) {
    ...
    return (
      <View style={[styles.card, styles.mixedCard]}>
        ...
        <Text style={styles.quote}>"{quote}"</Text>
        <Text style={styles.cta}>Partial effort is still effort. Complete it today.</Text>
      </View>
    );
  }
